...
import RecruiterLoginForm from "./Recruiter-Section/recruiterLoginForm";
    ...
    <div className="min-h-screen bg-white flex flex-col md:flex-row relative overflow-hidden">
        ...
        <div className="w-full max-w-2xl">
          ...
          <div className="flex space-x-4 mb-8 justify-center">
            <button
              ...
              className={`px-6 py-2 font-bold rounded-xl border transition ${activeTab === "user"
                  ? "bg-black text-white"
            ...
            <button
              ...
              className={`px-6 py-2 font-bold rounded-xl border transition ${activeTab === "recruiter"
                  ? "bg-black text-white"
                  : "bg-white text-black border-black"
                }`}
            >
          ...
          {activeTab === "user" ? (
            ...
            // Recruiter Login Form from separate file
            <RecruiterLoginForm />
          )}
        </div>
      </div>
      ...
      <div className="w-full md:w-1/2 flex flex-col items-center  p-12 text-center relative">
        ...
        <p className="text-xl text-gray-700 max-w-lg font-medium">
          Browse over <span className="font-bold">130K jobs</span> at top
